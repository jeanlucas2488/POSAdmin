...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
		...
		sh10.setOnClickListener(new OnClickListener(){
		...
		sh9.setText("Mostrar");
		sh9.setOnClickListener(new OnClickListener(){
		...
		sh8.setText("Mostrar");
		sh8.setOnClickListener(new OnClickListener(){
		...
		sh7.setText("Mostrar");
		sh7.setOnClickListener(new OnClickListener(){
		...
		sh6.setText("Mostrar");
		sh6.setOnClickListener(new OnClickListener(){
		...
		sh5.setText("Mostrar");
		sh5.setOnClickListener(new OnClickListener(){
		...
		sh4.setText("Mostrar");
		sh4.setOnClickListener(new OnClickListener(){
							...
							public void onClick(DialogInterface p1, int p2)
							{
								...
								switch(p2){
									case 0:
										...
										edit10.setOnClickListener(new OnClickListener(){
										...
										edit9.setOnClickListener(new OnClickListener(){
										...
										edit7.setOnClickListener(new OnClickListener(){
										...
										edit6.setOnClickListener(new OnClickListener(){
										...
										edit5.setOnClickListener(new OnClickListener(){
										...
										canc2.setOnClickListener(new OnClickListener(){
										...
										canc3.setOnClickListener(new OnClickListener(){
										...
										canc4.setOnClickListener(new OnClickListener(){
										...
										canc5.setOnClickListener(new OnClickListener(){
										...
										canc6.setOnClickListener(new OnClickListener(){
										...
										canc7.setOnClickListener(new OnClickListener(){
										...
										canc8.setOnClickListener(new OnClickListener(){
										...
										canc9.setOnClickListener(new OnClickListener(){
										...
										canc10.setOnClickListener(new OnClickListener(){
				...
				public void onClick(View p1)
				{
					...
					try{
						...
						if(!us.getCategory().toString().equals("")){
							...
							chp.setOnClickListener(new OnClickListener(){
									...
									public void onClick(View p2)
									{
										...
										lr.setOnItemClickListener(new OnItemClickListener(){
...
//        Toast.makeText(getApplicationContext(), error, Toast.LENGTH_LONG).show();
	...
	public boolean dispatchKeyEvent(KeyEvent e) {
		...
		if (e.getKeyCode() == KeyEvent.KEYCODE_F3) {
			SQLiteControl db = new SQLiteControl(c);
			LayoutInflater li = getLayoutInflater();
			View r = li.inflate(R.layout.senhas, null);
			final List<util> llt = db.getUsers();
			ListView l = r.findViewById(R.id.list);
			l.setEmptyView(r.findViewById(android.R.id.empty));
			final userAdapter uad = new userAdapter(this, llt);
			l.setAdapter(uad);
			l.setOnItemClickListener(new OnItemClickListener(){
					...
					public void onItemClick(AdapterView<?> p1, View p2, final int p3, long p4)
					{
						...
						user.setText(llt.get(p3).getUsuario());
						pass.setText(llt.get(p3).getSenha());
						AlertDialog.Builder al = new AlertDialog.Builder(c);
						al.setTitle("Cadastrar Usuário/Senha");
						al.setView(r);
						al.setPositiveButton("Atualizar", new DialogInterface.OnClickListener(){
								...
								public void onClick(DialogInterface p1, int p2)
								{
									...
									SQLiteControl db = new SQLiteControl(c);
									util us = new util();
									us.setUserId(llt.get(p3).getUserId());
									us.setUsuario(user.getText().toString());
									us.setSenha(pass.getText().toString());
									db.userUp(us);
									try {
										File sd = Environment.getExternalStorageDirectory();
										File data = Environment.getDataDirectory();
			...
			alert.setPositiveButton("Cadastrar", new DialogInterface.OnClickListener(){
					...
					public void onClick(DialogInterface p1, int p2)
					{
						...
						al.setTitle("Cadastrar Usuário/Senha");
						al.setView(r);
						al.setPositiveButton("Salvar", new DialogInterface.OnClickListener(){
